...
jQuery(document).on('ready ajaxComplete', function () {
	...
	jQuery(".add-button").click((event) => {
      ...
      let radio3 = "raido-"+tagsNum-1;
			...
			jQuery("#course-tag-container").append('<nav class="tag"> <label for="'+btn+'" class="button bold-me" onclick="rotate(event)">'+course_name+'<span class="fas fa-caret-down arrow" ></span> </label><input type="checkbox" id="'+btn+'"> <ul class="menu"> <li> <label for="" class="title course">Express Program Preference:</label> <label for="'+radio1+'" class="radio"> <input type="radio" name="'+course_name+'" id="'+radio1+'" class="radio__input"> <div class="radio__radio"></div> A Must </label> <label for="'+radio2+'" class="radio"> <input type="radio" name="'+course_name+'" id="'+radio2+'" class="radio__input"> <div class="radio__radio"></div> Would Like </label> <label for="'+radio3+'" class="radio"> <input type="radio" name="'+course_name+'" id="'+radio3+'" class="radio__input" checked> <div class="radio__radio"></div> No Preference </label> </li> <li> <div class="divider"></div> </li> <li> <label for="" class="course-title">Expected Party Size:</label> <i class="fas fa-user"></i><input type="number" name="" value="1" min="1" class="people" id="total"> <button onclick="minus()" class="a">-</button> <button onclick="add()" class="b">+</button> </li> <li> <div class="divider"></div> </li> <li> <button onclick="tagDelete(event)" class="remove-course">Remove Course</button> </li> </ul></nav>');
